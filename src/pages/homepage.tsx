...
const Homepage: React.FC = () => {
  ...
  const osData = [
    ...
    { name: "BlackBerry OS", slug: "blackberry", description: "Delve into BlackBerry OS, known for its security, enterprise features, and iconic keyboard.", icon: <Smartphone className="h-10 w-10 text-purple-500" /> },
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <section className="text-center py-12">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Your comprehensive guide to understanding MS-DOS, Linux, macOS, BlackBerry OS, and Android.
          </p>
        </section>

        <section className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          {osData.map((os) => (
        ...
        <section className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                    <CardDescription>See a side-by-side comparison of MS-DOS, Linux, macOS, BlackBerry OS, and Android.</CardDescription>
                </CardContent>
                <CardFooter>
